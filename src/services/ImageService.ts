    ...
    async convertFormat(
        ...
        switch (format) {
            case "jpeg":
                return await instance
                    .jpeg({
                        quality: options?.quality ?? DEFAULT_COMPRESSION.jpeg.quality,
                        progressive:
                            options?.progressive ??
            ...
            case "webp":
                return await instance
                    .webp({
                        quality: options?.quality ?? DEFAULT_COMPRESSION.webp.quality,
                        effort: options?.effort ?? DEFAULT_COMPRESSION.webp.effort,
                        lossless:
                            options?.lossless ?? DEFAULT_COMPRESSION.webp.lossless,
                    })
                    .toBuffer();
            ...
            case "avif":
                return await instance
                    .avif({
                        quality: options?.quality ?? DEFAULT_COMPRESSION.avif.quality,
                        effort: options?.effort ?? DEFAULT_COMPRESSION.avif.effort,
                    })
                    .toBuffer();
            ...
            case "tiff":
                return await instance
                    .tiff({
                        quality: options?.quality ?? DEFAULT_COMPRESSION.tiff.quality,
                    })
                    .toBuffer();
