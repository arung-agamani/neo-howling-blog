...
export default async function GalleryPage() {
    ...
    return (
        <main className="min-h-screen bg-[#09090f]">
            {/* Header */}
            <header className="sticky top-0 z-20 bg-[#09090f]/90 backdrop-blur-md border-b border-white/[0.06]">
            ...
            {/* Footer */}
            <footer className="max-w-7xl mx-auto px-4 sm:px-6 py-8 mt-4 border-t border-white/[0.06]">
