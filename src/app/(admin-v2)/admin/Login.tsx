                ...
                <div className="bg-slate-50 bg-opacity-90 p-8 flex flex-col justify-center">
                    <div className="text-right space-y-4">
                        ...
                        <div className="text-sm lg:text-base text-slate-600 space-y-4">
                            <p>
                                While the world was at its end, a group of
                                mysterious spirits approached the neverending
                                stream of wind with chance of gold threads.
                            </p>
                            <p>
                                It wasn&apos;t obvious at first, but soon as
                                they manifested themselves into a single entity,
                                sacrifices were bound to happen.
                            </p>
                            <p className="italic">
                                &ldquo;See you at the other side,
                                Elfrieden...&rdquo;
                            </p>
                            <p>
                                Your Soul Holding my heart and my soul in my
                                both hands, I faced the gate which would take me
                                beyond the dimension a mere human can
                                comprehend...
                            </p>
                        </div>
                    </div>
