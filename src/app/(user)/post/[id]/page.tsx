...
export default async function Page({ params }: { params: Params }) {
  ...
  headerLists.get("a");
  const data = await fetch(`${baseUrl}/api/post?id=${params.id}`).then((res) =>
    res.json()
  );
  // console.log(data.blogContent);

  return (
    <div className="container mx-auto max-lg bg-white px-4 pt-4 overflow-hidden">
      ...
      <div
        ...
        className="mx-2 lg:mx-10 mt-10 font-sans font-normal markdown-body"
      />
