...
export default async function Page() {
  ...
  return (
    <div className="bg-white pt-2 flex flex-col  justify-center max-w-lg lg:max-w-none mx-auto pb-12 lg:px-16">
      <p className="max-w-5xl text-white text-xl text-center mx-auto my-2 py-8 px-4 border border-gray-600 rounded">
        ...
        <br />
        Use the navigation bar above and floating buttons on bottom left of the
